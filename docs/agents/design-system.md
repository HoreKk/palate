...
_display_ face for headings and a monospace face demoted to _micro-labels_.
...
<link
  href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:ital,wght@0,400;0,500;0,700;1,400&family=Space+Grotesk:wght@400;500;600;700&display=swap"
  rel="stylesheet"
/>
```
...
:root {
  ...
  /* semantic */
  --good: #56c08a;
  --good-dim: #56c08a1f; /* pass / correct call */
  --bad: #f0654a;
  --bad-dim: #f0654a1f; /* fail / missed call */
...
accent "cut" line at the decision point. The rest of any page should _not_ read
as an IDE.
